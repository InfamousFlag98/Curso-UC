...
def main():
    sp = spotipy.Spotify(auth_manager=SpotifyOAuth(
        client_id="ALTERAR AQUI",
        client_secret="ALTERAR AQUI",
    ...
    if choice == "1":
        ...
        print("ATENÇÃO: Esta opção irá limpar a playlist e torná-la privada. O Spotify não permite excluir playlists permanentemente.")
